python -m domainbed.scripts.sweep relaunch\
    ...
    --output_dir=./results/nlpgerm_oh_noise_level_analysis_v2/noise0/  \
...
python -m domainbed.scripts.sweep launch\
    --data_dir=/mnt/VOL6/fangzhou/local/trainningcode/zilin_dg/NoiseRobustDG-main/data \
    --output_dir=./results/nlpgerm_oh_noise_level_analysis_v2/noise0.1/  \
    --command_launcher multi_gpu    \
    --algorithms NLPGERM     \
    --datasets OfficeHome  \
    --skip_confirmation \
...
python -m domainbed.scripts.sweep launch\
    --data_dir=/mnt/VOL6/fangzhou/local/trainningcode/zilin_dg/NoiseRobustDG-main/data \
    --output_dir=./results/nlpgerm_oh_noise_level_analysis_v2/noise0.2/  \
    --command_launcher multi_gpu    \
    --algorithms NLPGERM     \
    --datasets OfficeHome  \
    --skip_confirmation \
...
python -m domainbed.scripts.sweep launch\
    --data_dir=/mnt/VOL6/fangzhou/local/trainningcode/zilin_dg/NoiseRobustDG-main/data \
    --output_dir=./results/nlpgerm_oh_noise_level_analysis_v2/noise0.3/  \
    --command_launcher multi_gpu    \
    --algorithms NLPGERM     \
    --datasets OfficeHome  \
    --skip_confirmation \
...
python -m domainbed.scripts.sweep launch\
    --data_dir=/mnt/VOL6/fangzhou/local/trainningcode/zilin_dg/NoiseRobustDG-main/data \
    --output_dir=./results/nlpgerm_oh_noise_level_analysis_v2/noise0.4/  \
    --command_launcher multi_gpu    \
    --algorithms NLPGERM     \
    --datasets OfficeHome  \
    --skip_confirmation \
...
python -m domainbed.scripts.sweep launch\
    --data_dir=/mnt/VOL6/fangzhou/local/trainningcode/zilin_dg/NoiseRobustDG-main/data \
    --output_dir=./results/nlpgerm_oh_noise_level_analysis_v2/noise0.5/  \
    --command_launcher multi_gpu    \
    --algorithms NLPGERM     \
    --datasets OfficeHome  \
    --skip_confirmation \
