python -m domainbed.scripts.sweep relaunch\
    ...
    --output_dir=./results/nlpgerm_l2_vlcs/  \
    --command_launcher multi_gpu    \
    --algorithms NLPGERM_L2     \
    --datasets VLCS  \
    --skip_confirmation \
    --n_hparams_from 0  \
    --n_hparams 5       \
...
python -m domainbed.scripts.sweep relaunch\
    --data_dir=/mnt/VOL6/fangzhou/local/trainningcode/zilin_dg/NoiseRobustDG-main/data \
    --output_dir=./results/nlpgerm_l2_pacs/  \
    --command_launcher multi_gpu    \
    --algorithms NLPGERM_L2     \
    --datasets PACS  \
    --skip_confirmation \
...
python -m domainbed.scripts.sweep relaunch\
    --data_dir=/mnt/VOL6/fangzhou/local/trainningcode/zilin_dg/NoiseRobustDG-main/data \
    --output_dir=./results/nlpgerm_l2_oh/  \
    --command_launcher multi_gpu    \
    --algorithms NLPGERM_L2     \
    --datasets OfficeHome  \
    --skip_confirmation \
...
python -m domainbed.scripts.sweep relaunch\
    --data_dir=/mnt/VOL6/fangzhou/local/trainningcode/zilin_dg/NoiseRobustDG-main/data \
    --output_dir=./results/nlpgerm_l2_terra  \
    --command_launcher multi_gpu    \
    --algorithms NLPGERM_L2     \
