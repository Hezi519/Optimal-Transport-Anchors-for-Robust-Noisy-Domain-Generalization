        ...
        for i in range(data[alg].shape[0]):
            ...
            if trial_i.ndim == 2:
                for j in range(trial_i.shape[0]):
                    ...
                    plt.plot(trajectory, label=alg+f'_test_group{j}', linewidth=3)
            else:
                plt.plot(trial_i, label=alg+'_test', linewidth=3)
            ...
            if val_data is not None:
                ...
                if val_trial_i.ndim == 2:
                    for j in range(val_trial_i.shape[0]):
                        ...
                        plt.plot(trajectory, label=alg+f'_val_group{j}', linewidth=3)
                else:
                    plt.plot(val_trial_i, label=alg+'_val', linewidth=3)
            ...
            if train_data is not None:
                ...
                if train_trial_i.ndim == 2:
                    for j in range(train_trial_i.shape[0]):
                        ...
                        plt.plot(trajectory, label=alg+f'_train_group{j}',linewidth=3)
                else:
                    plt.plot(train_trial_i, label=alg+'_train', linewidth=3)
            ...
            # ax.xaxis.set_major_locator(ticker.MultipleLocator(300))  # ticks every 300 steps
            # ax.xaxis.set_major_formatter(ticker.FuncFormatter(lambda x, pos: f"{int(x*300)}"))
