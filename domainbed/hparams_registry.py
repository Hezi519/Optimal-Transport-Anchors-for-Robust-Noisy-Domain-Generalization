...
def _hparams(algorithm, dataset, random_seed):
    ...
    # Noise analysis
    _hparam('input_noise', None, lambda r: None)
    _hparam('grad_noise', None, lambda r: None)
    _hparam('domain_noise', None, lambda r: None)
    _hparam('feature_noise', None, lambda r: None)
